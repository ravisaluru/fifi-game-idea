...
class WorldSelectScreen extends StatelessWidget {
  ...
  static const _worlds = [
    _WorldCard(id: WorldId.tiger,    emoji: '🐯', name: 'Tiger Plains',
        gradient: [Color(0xFFFF8F00), Color(0xFFE65100)]),
    _WorldCard(id: WorldId.firefly,  emoji: '🧚', name: 'Firefly Forest',
        gradient: [Color(0xFF1B5E20), Color(0xFF4CAF50)]),
    _WorldCard(id: WorldId.bubble,   emoji: '🫧', name: 'Bubble World',
        gradient: [Color(0xFF1565C0), Color(0xFF42A5F5)]),
    _WorldCard(id: WorldId.stones,   emoji: '🪨', name: 'Stepping Stones',
        gradient: [Color(0xFF4E342E), Color(0xFF8D6E63)]),
    _WorldCard(id: WorldId.star,     emoji: '⭐', name: 'Star Shower',
        gradient: [Color(0xFF0D1B4B), Color(0xFF1A237E)]),
    _WorldCard(id: WorldId.snake,    emoji: '🐍', name: 'Snake Grassland',
        gradient: [Color(0xFF33691E), Color(0xFF8BC34A)]),
    _WorldCard(id: WorldId.treasure, emoji: '🪙', name: 'Treasure Hunt',
...
class _WorldCard {
  ...
  const _WorldCard({
    ...
    required this.name, required this.gradient,
  });
}
